    ...
    >
      ...
      <div className="relative text-center">
        ...
        <div className="absolute inset-0 -m-8 rounded-full
                        bg-[radial-gradient(ellipse,hsl(145_52%_48%/0.12)_0%,transparent_70%)]
                        pointer-events-none" aria-hidden="true" />

        <p className="relative font-mono text-[10px] text-muted-foreground/40 tracking-[0.4em] uppercase mb-2">
          {t.eyebrow}
        </p>
        <h1
          id="done-title"
          className="relative font-display text-[78px] leading-[0.85] text-success uppercase"
        >
          {t.title}
        </h1>
      </div>
      ...
      <div className="flex flex-col gap-2.5 w-full max-w-sm">
        <button
          ...
          className="h-11 w-full rounded bg-primary text-primary-foreground
